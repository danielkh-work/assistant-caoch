...
return new class extends Migration
{
    ...
    {
        Schema::create('websocket_practice_scoreboards', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('expected_yard_gain')->nullable();
    ...
    {
        Schema::dropIfExists('websocket_practice_scoreboards');
    }
};
